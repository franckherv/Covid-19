...
class SearchScreenEnAttente extends StatefulWidget {
  static const routeName = '/SearchScreen-attente';
  @override
  _SearchScreenEnAttenteState createState() => _SearchScreenEnAttenteState();
}

class _SearchScreenEnAttenteState extends State<SearchScreenEnAttente> {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, index) {
                        Decaissement decaissement = tmpList.length > 0
                            ? tmpList[index]
                            : snapshot.data![index];
                        return WelcomePageWidgetAttente(
