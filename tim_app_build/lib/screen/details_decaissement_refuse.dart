...
// class DetailsDecaissementRefuse extends StatelessWidget {
//   static const routeName = '/decaissement-details-refus';
//   @override
...
//     final detail = Provider.of<Decaissements>(context).findById(decaissementId);
...
//                             child: Text('${detail.numeroDecaissement}',
//                                 style: TextStyle(
...
//                         child: SingleChildScrollView(
//                           scrollDirection: Axis.vertical,
//                           child: Text('${detail.commentaireStatut}',
//                               style: TextStyle(
//                                 color: Colors.black,
//                                 fontSize: 16,
//                               )),
