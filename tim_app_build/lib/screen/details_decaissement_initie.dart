...
// class DetailsDecaissementInitie extends StatelessWidget {
//   static const routeName = '/decaissement-details-initie';
//   @override
...
// // import 'package:billsoft/model/decaissement.dart';
// // import 'package:billsoft/provider/decaissement_providers.dart';
// // import 'package:billsoft/widgets/listViewBuilder.dart';
// // import 'package:flutter/material.dart';
// // import 'package:provider/provider.dart';
...
// //                     elevation: 10,
// //                     child: ListTile(
// //                         title: Text(decaissements[i].beneficiaire),
// //                         subtitle: Text(decaissements[i].motif),
// //                         trailing: Text(decaissements[i].montant.toString())),
...
class DetailsDecaissementInitie extends StatefulWidget {
  static const routeName = '/decaissement-details-initie';

  @override
  State<DetailsDecaissementInitie> createState() =>
      _DetailsDecaissementInitieState();
}

class _DetailsDecaissementInitieState extends State<DetailsDecaissementInitie> {
  @override
  Widget build(BuildContext context) {
    //final decaissementData = Provider.of<Decaissements>(context).items;
    // final decaissements = decaissementData;
