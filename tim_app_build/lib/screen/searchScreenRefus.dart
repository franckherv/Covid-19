...
class SearchScreenRefus extends StatefulWidget {
  static const routeName = '/SearchScreen-refus';
  @override
  _SearchScreenRefusState createState() => _SearchScreenRefusState();
}

class _SearchScreenRefusState extends State<SearchScreenRefus> {
