...
import 'package:ice_shop/models/user.dart';
import 'package:ice_shop/services/service_user.dart';
import 'package:ice_shop/services/services_order.dart';
...
//      if(!itemExists){
      ...
      _userServices.addToCart( _user.uid, item);
//      }
  ...
  Future<bool> removeFromCart(CartItemModel cartItem)async{
    ...
    try{
      _userServices.removeFromCart( _user.uid, cartItem);
      return true;
    }catch(e){
      print("THE ERROR ${e.toString()}");
      return false;
